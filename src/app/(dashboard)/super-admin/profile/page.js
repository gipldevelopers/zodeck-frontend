...
export default function SuperAdminProfilePage() {
    ...
    const transformApiData = (apiData) => {
        // Fallback if employee object isn't present (e.g. strict super admin model without employee record)
        const employee = apiData.employee || {};
        const user = apiData.user || {}; // Incase some data is on the user object directly
        ...
        return {
            ...
            employment: {
                ...
                designation: employee.designation?.name || 'Super Admin',
    ...
    return (
        <div className="bg-gray-50 min-h-screen dark:bg-gray-900 p-4 sm:p-6">
            <Breadcrumb pageTitle="Super Admin Profile" rightContent={null} />
