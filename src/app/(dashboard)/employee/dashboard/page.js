    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-primary-50/20 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 p-4 sm:p-6">
      <div className="max-w-7xl mx-auto space-y-4 sm:space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6 auto-rows-min">
          {/* User Greeting Card - Spans 12 columns on mobile, 8 on desktop */}
          <div className="lg:col-span-8">
            <UserGreetingCard />
          </div>

          {/* Leave Widget - Spans 12 columns on mobile, 4 on desktop */}
          <div className="lg:col-span-4">
            <LeaveWidget data={dashboardData?.leaves} />
          </div>

          {/* Office Hours Tracker - Spans 12 columns on mobile, 4 on desktop */}
          <div className="lg:col-span-4 min-h-[420px]">
            <OfficeHoursTracker />
          </div>

          {/* Attendance Calendar - Spans 12 columns on mobile, 8 on desktop */}
          <div className="lg:col-span-8 min-h-[420px]">
            <AttendanceCalendar />
          </div>

          {/* Payroll Widget - Spans 12 columns on mobile, 6 on desktop */}
          <div className="lg:col-span-6">
            <PayrollWidget data={dashboardData?.payroll} />
          </div>

          {/* Pending Requests Widget - Spans 12 columns on mobile, 6 on desktop */}
          <div className="lg:col-span-6">
            <PendingRequestsWidget data={dashboardData?.requests} />
          </div>

          {/* Notifications Widget - Spans 12 columns */}
