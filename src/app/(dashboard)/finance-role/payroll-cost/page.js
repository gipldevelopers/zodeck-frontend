          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 relative z-10">
            <div className="flex items-center gap-5">
              ...
              >
                ...
                />
                <FileCheck className="w-10 h-10 relative z-10" />
              </motion.div>
              <div>
                <motion.h1
                ...
                >
                  Review payroll financials before payout. View summaries, department and cost center breakdowns, and flag discrepancies.
                </motion.p>
              </div>
            </div>
