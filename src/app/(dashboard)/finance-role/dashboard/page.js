          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 relative z-10">
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                >
                  Comprehensive financial overview, expense management, and payout readiness.
                </motion.p>
              </div>
            </div>
            ...
            >
              <motion.div
                ...
                className="text-sm font-semibold bg-card/60 dark:bg-card/30 backdrop-blur-xl px-5 py-3 rounded-2xl border-2 border-border/30 dark:border-border/10 flex items-center gap-3 shadow-xl"
              >
                <motion.span
