...
//           }}
//           transition={{ duration: 25, repeat: Infinity, ease: "easeInOut" }}
//           className="absolute bottom-1/4 -right-20 w-[500px] h-[500px] bg-purple-500/10 rounded-full blur-3xl"
//         />
//       </div>
...
//               animate={{ opacity: 1, y: 0 }}
//               transition={{ delay: 0.2 }}
//               className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-600/10 border border-blue-600/20 text-blue-600 text-sm font-medium mb-6"
//             >
//               <Sparkles className="w-4 h-4" />
//               <span>Manifesting Growth for Indian SMEs</span>
//             </motion.div>
...
//               animate={{ opacity: 1, y: 0 }}
//               transition={{ delay: 0.3 }}
//               className="font-bold text-4xl sm:text-5xl lg:text-6xl xl:text-7xl text-gray-900 leading-tight mb-6"
//             >
//               The Complete{" "}
...
//               className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start"
//             >
//               <Button size="lg" className="bg-blue-600 hover:bg-blue-700 text-white rounded-full px-8 text-base group">
//                 Start Your Free Trial
//                 <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
//               </Button>
//               <Button 
//                 size="lg" 
//                 variant="outline" 
//                 className="rounded-full px-8 text-base border-2 border-gray-300 hover:border-gray-400 group"
//               >
...
//               animate={{ opacity: 1, y: 0 }}
//               transition={{ delay: 0.7 }}
//               className="flex justify-center lg:justify-start gap-8 mt-12 pt-8 border-t border-gray-200/50"
//             >
//               {stats.map((stat, index) => (
//                 <div key={index} className="text-center lg:text-left">
...
//           animate={{ y: [0, 10, 0] }}
//           transition={{ duration: 2, repeat: Infinity }}
//           className="w-6 h-10 rounded-full border-2 border-gray-400/30 flex items-start justify-center p-2"
//         >
//           <motion.div
//             animate={{ y: [0, 12, 0] }}
//             transition={{ duration: 2, repeat: Infinity }}
